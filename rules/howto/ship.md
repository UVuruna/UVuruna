# HOWTO — build an installable app and publish the release
...
Runs ONLY after the owner asked for a build/release in that session
(`rules/BUILD.md` — the Release Law is reversed since 2026-08-18). Never
automatic, never by a sub-agent.
