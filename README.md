...
| <img src="logos/3DPreview.svg" width="22" height="22"> | 3D Preview | 🟢 Active | Embeddable 3D previewer — one Three.js core with orbit controls, embedded by PySide6 apps as a widget or by websites with a script tag; simple shapes computed from parametric specs |
