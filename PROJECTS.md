...
**Description:** Multi-bookmaker Redacted game automation system. Collects real-time game data via OCR screen reading and WebSocket connections, runs ML models for round predictions, and executes automated betting decisions. Designed around a Worker Process pattern for parallel execution.
